...
import com.xevrae.domain.data.model.ui.ScreenSizeInfo
import com.xevrae.logger.Logger
import com.xevrae.getPlatform
import com.xevrae.ui.theme.md_theme_dark_background
import com.xevrae.ui.theme.shimmerBackground
import com.xevrae.ui.theme.shimmerLine
...
fun String.hexToColorOrNull(): Color? =
    runCatching {
        val clean = removePrefix("#").trim()
        when (clean.length) {
            6 -> Color(clean.toLong(16) or 0x00000000FF000000L)
