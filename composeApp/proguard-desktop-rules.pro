...
-keep class com.xevrae.domain.data.model.** { *; }
...
-keep class com.xevrae.data.model.** { *; }
-keep class com.xevrae.extension.AllExtKt { *; }
-keep class com.xevrae.extension.AllExtKt$* { *; }
-keep class com.xevrae.kotlinytmusicscraper.extension.MapExtKt$* { *; }
...
-dontwarn com.xevrae.data.di.loader.LoaderKt
-dontwarn com.xevrae.media3.ui.MediaPlayerViewKt

-keep class com.xevrae.data.di.loader.LoaderKt { *; }
-keep class com.xevrae.data.mapping.MappingKt { *; }
-keep class com.xevrae.data.extension.** { *; }
-keep class com.xevrae.data.di.** { *; }

-keep class com.xevrae.kotlinytmusicscraper.** { *; }

-keep class org.xevrae.lyrics.parser.** { *; }
-keep class org.xevrae.lyrics.models.** { *; }
-keep class org.xevrae.nowplayingcenter.** { *; }
