# CLAUDE.md - Xevrae Project Guide for AI Agents

## 📋 Project Overview

**Xevrae** is a FOSS (Free and Open Source Software) YouTube Music client for Android and Desktop, built with Compose Multiplatform.
...
- **lyricsService/**: Lyrics fetching (LRCLIB, Xevrae Lyrics, BetterLyrics)
...
- **Features**:
  - Deep link support (`xevrae://` and `xevrae.org`)
...
**Location**: `core/media/media-jvm/src/main/java/com/xevrae/media_jvm/VlcPlayerAdapter.kt`
...
**Location**: `core/media/media3/src/main/java/com//media3/exoplayer/CrossfadeExoPlayerAdapter.kt`
...
### Translation
- Use Crowdin: https://crowdin.com/project/xevrae
...
- **Xevrae Chart**: Chart playlists integrated into Library screen
...
- **Xevrae Lyrics voting**: Vote functionality for community lyrics

### New Features (post-1.0.4, dev branch)
- **Deep link support**: `xevrae://` and `xevrae.org` URL schemes
...
*This document helps AI Agents quickly understand the Xevrae project. Update regularly when there are major changes to architecture or structure.*

**Last updated**: 2026-03-14
**Project version**: Check latest release on GitHub
**Maintained by**: t4ulquiorra and contributors
