package com.xevrae.service.backup
...
import com.xevrae.common.DOWNLOAD_EXOPLAYER_FOLDER
import com.xevrae.common.EXOPLAYER_DB_NAME
...
class AutoBackupWorker(
    ...
    private fun saveToDownloads(backupFile: File): Boolean {
        ...
        val fileName = "xevrae_backup_$timestamp.zip"
        ...
        return try {
            val contentValues = ContentValues().apply {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                    put(MediaStore.Downloads.RELATIVE_PATH, "Download/Xevrae")
                }
            }
            ...
            uri?.let { outputUri ->
                ...
                Logger.i(TAG, "Backup saved to Downloads/Xevrae/$fileName")
                true
            } ?: false
        } catch (e: Exception) {
    ...
    private fun cleanupOldBackups(maxFiles: Int) {
        try {
            ...
            val selectionArgs = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                arrayOf("Download/Xevrae/", "xevrae_backup_%.zip")
            } else {
                arrayOf("xevrae_backup_%.zip")
            }
            ...
            context.contentResolver.query(
                ...
                while (cursor.moveToNext()) {
                    ...
                    if (name.startsWith("xevrae_backup_") && name.endsWith(".zip")) {
