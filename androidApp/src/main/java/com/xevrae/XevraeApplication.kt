...
import com.music.innertube.utils.cipher.CipherDeobfuscator
...
import com.xevrae.service.backup.AutoBackupScheduler
...
import org.xevrae.crashlytics.configCrashlytics
import java.lang.reflect.Field

class XevraeApplication :
    Application(),
    KoinComponent,
    ...
    override fun onCreate() {
        ...
        // Initialize XiaoRi Fast Engine WebView
        ...
        startKoin {
            ...
            androidContext(this@XevraeApplication)
            loadAllModules()
